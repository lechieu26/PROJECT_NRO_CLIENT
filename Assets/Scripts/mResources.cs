public class mResources
{
	...
	public static string[] key_skill_qwerty = new string[12]
	{
		string.Empty,
		string.Empty,
		string.Empty,
	...
	public static string[] key_skill = new string[12]
	{
		string.Empty,
		string.Empty,
		string.Empty,
	...
	public static string changeIP = string.Empty;
	...
	public static string ONAUTOITEM = string.Empty;

	public static string OFFAUTOITEM = string.Empty;
