...
public static class RongThanSpineController
{
    ...
    public static void Show(int x, int y)
    {
        ...
        Debug.Log("[RongThanSpine] Show Earth dragon Spine at " + x + "," + y);
    }
    ...
    private static void EnsureLoaded()
    {
        ...
        {
            Debug.LogWarning("[RongThanSpine] Missing Spine assets, fallback to Effect 17. skel=" + (skel != null) + " atlas=" + (atlas != null) + " tex=" + (texture != null));
            failed = true;
            return;
        }
        ...
        {
            Debug.LogWarning("[RongThanSpine] Could not load skeleton data, fallback to Effect 17.");
            failed = true;
            return;
        }

        loaded = true;
        Debug.Log("[RongThanSpine] Runtime assets loaded OK.");
    }
    ...
    private static void CreateInstance()
    {
        ...
        go = new GameObject("RongThanTraiDatSpine");
    ...
    private static void EnsureOverlayCamera()
    {
        ...
        GameObject camGo = new GameObject("RongThanSpineOverlayCamera");
